...
function Home() {
  ...
  useEffect(async () => {
    let res = await axios.get("https://jsonblob.com/api/987228769794408448");
    ...
    <div>
      <div className="container-fluid">
        <div className="row">
          <Col></Col>
          <Col>
            <InputGroup className=" searchfield justify-content-center my-3 mx-2">
              <FormControl
          ...
          <Col className="px-0">
            <div className="dropdown d-block">
              <button
                className="btn btn-secondary dropdown-toggle mt-3 mb-3"
                type="button"
              ...
              >
                ...
                <li className="dropdown-item" onClick={() => filtetThriller()}>
                  Thriller
                </li>
