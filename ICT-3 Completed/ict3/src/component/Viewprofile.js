    ...
    <div>
      ...
      <Card className="mt-5 w-50 mx-auto">
        <div className="ctr-item">
          <h5 className="item">Customer ID: {profile._id}</h5>
          <h5 className="item">Name: {profile.name}</h5>
          <h5 className="item">Email: {profile.email}</h5>
          <h5 className="item">Phone No: {profile.phoneno} </h5>
          <h5 className="item"> Location: {profile.location} </h5>
        </div>
